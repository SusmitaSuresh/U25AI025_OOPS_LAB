...
public class lab7_pr7 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        char c[] = new char[8];
        char[] ans = {'C','A','B','D'};   //manually declaring the correct answers in an array 
        Result[] answers = new Result[8];
        System.out.println("enter 4 questions answers, A, B, C, D, or X for no answer: ");
        for(int i=0; i<4; i++)
        {
